...
Spring Boot의 MVC패턴과 React.js를 기반으로 만든 스터디 공유 플랫폼입니다. 난무하는 화상 스터디로 피로감을 느낀 사람들을 위해, 혼자서 편하게 공부하며 정확하게 공부시간을 측정하고 
스터디를 통해 실시간 Todo 공유 및 채팅으로 정보를 나누고 동기를 부여받을 수 있는 플랫폼을 개발했습니다. 
...
- ## TODO 공부방
  ...
  - 방장이 방을 나간 경우 다음에 들어온 회원이 방장으로 배정됩니다.
